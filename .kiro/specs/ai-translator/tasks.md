...
- [x] 2.1 Write unit tests for StorageService
...
- [x] 2.2 Write property test for API key persistence
  - **Property 1: API Key Persistence Round Trip**
  - **Validates: Requirements 6.2, 6.3**

- [x] 2.3 Write property test for model selection persistence
  - **Property 2: Model Selection Persistence**
  - **Validates: Requirements 5.4**

- [x] 2.4 Write property test for settings persistence completeness
  - **Property 8: Settings Persistence Completeness**
  - **Validates: Requirements 13.4**

- [x] 3. Implement OpenRouterService with tests
...
- [x] 3.1 Write unit tests for OpenRouterService
...
- [x] 3.2 Write property test for translation request format
  - **Property 5: Translation Request Format**
  - **Validates: Requirements 1.1**

- [x] 3.3 Write property test for model list filtering
  - **Property 10: Model List Filtering**
  - **Validates: Requirements 5.1, 5.2**

- [x] 4. Create ApiKeyGate component with tests
  - Build form for API key entry
  - Add validation and loading states
  - Style with dark theme
  - _Requirements: 6.1, 11.2_

- [x] 4.1 Write unit tests for ApiKeyGate
...
- [x] 5. Create basic App component with API key gating
...
- [x] 5.1 Write unit tests for App component
  - Test initial render with no API key
  - Test initial render with stored API key
  - Test API key submission flow
  - _Requirements: 6.1, 6.3_

- [x] 6. Checkpoint - Verify API key flow works end-to-end
  - Ensure all tests pass, ask the user if questions arise.

- [x] 7. Create LanguageSelector component with tests
...
- [x] 7.1 Write unit tests for LanguageSelector
...
- [x] 7.2 Write property test for language swap idempotence
  - **Property 3: Language Swap Idempotence**
  - **Validates: Requirements 7.4**

- [x] 8. Create InputPanel component with tests
...
- [x] 8.1 Write unit tests for InputPanel
...
- [x] 8.2 Write property test for character count accuracy
  - **Property 7: Character Count Accuracy**
  - **Validates: Requirements 8.4**

- [x] 9. Create OutputPanel component with tests
...
- [x] 9.1 Write unit tests for OutputPanel
...
- [x] 9.2 Write property test for copy operation fidelity
  - **Property 9: Copy Operation Fidelity**
  - **Validates: Requirements 9.1**

- [x] 10. Create ContextPanel component with tests
  - Build textarea for context input
  - Style with dark theme
  - _Requirements: 2.1, 2.3_

- [x] 10.1 Write unit tests for ContextPanel
  - Test textarea rendering and input
  - Test controlled component behavior
  - _Requirements: 2.1, 2.3_

- [x] 10.2 Integrate ContextPanel into App.tsx
  - Add ContextPanel below the input/output panels
  - Wire up state and handlers
  - Verify component displays correctly in the UI

- [x] 11. Create ModelSelector component with tests
...
- [x] 11.1 Write unit tests for ModelSelector
  - Test rendering with model list
  - Test model selection change
  - Test selected model display
  - _Requirements: 5.2, 5.3, 5.4_

- [x] 11.2 Integrate ModelSelector into App.tsx
  - Add ModelSelector to the settings area
  - Wire up model state and handlers
  - Verify component displays correctly in the UI

- [x] 12. Create SettingsPanel component with tests
  - Build collapsible panel
  - Include ModelSelector
  - Add clear API key button
  - Style with dark theme
  - _Requirements: 13.1, 13.2, 13.3, 13.5, 6.4_

- [x] 12.1 Write unit tests for SettingsPanel
  - Test panel open/close toggle
  - Test model selector integration
  - Test clear API key button functionality
  - _Requirements: 13.1, 13.2, 13.5, 6.4_

- [x] 12.2 Integrate SettingsPanel into App.tsx
  - Add SettingsPanel to the header area
  - Wire up settings state and clear API key handler
  - Verify component displays correctly in the UI

- [x] 13. Create TranslationInterface component with tests
...
- [x] 13.1 Write unit tests for TranslationInterface
...
- [x] 14. Checkpoint - Verify translation interface renders correctly
  - Ensure all tests pass, ask the user if questions arise.

- [x] 15. Implement translation validation logic with tests
...
- [x] 15.1 Write unit tests for validation logic
...
- [x] 15.2 Write property test for empty input validation
  - **Property 4: Empty Input Validation**
  - **Validates: Requirements 8.5, 11.1**

- [x] 16. Implement error handling and display with tests
...
- [x] 16.2 Write property test for error message display
  - **Property 6: Error Message Display**
  - **Validates: Requirements 11.3, 11.4**

- [x] 17. Integrate model fetching in App component with tests
...
- [x] 17.1 Write unit tests for model fetching
...
- [x] 18. Implement model persistence with tests
...
- [x] 18.1 Write unit tests for model persistence
  - Test loading stored model on mount
  - Test saving model on selection change
  - Test default model selection
  - _Requirements: 5.4_

- [x] 19. Implement language preference persistence with tests
...
- [x] 20.1 Write unit tests for responsive behavior
  - Test mobile layout rendering
  - Test desktop layout rendering
  - Test swap button rotation on mobile
  - _Requirements: 12.1, 12.2, 12.5_

- [x] 21. Implement visual feedback animations with tests
...
- [x] 21.1 Write unit tests for visual feedback
...
- [x] 22. Implement translation prompt engineering with tests
...
- [x] 22.1 Write unit tests for prompt engineering
...
- [x] 23. Implement transcription logic with tests
...
- [x] 23.1 Write unit tests for transcription logic
...
- [x] 24. Checkpoint - Verify complete translation flow works
  - Ensure all tests pass, ask the user if questions arise.

- [x] 25. Add dark theme styling
  - Apply dark color scheme to all components
  - Ensure proper contrast ratios
  - Test readability
  - _Requirements: 14.1, 14.2, 14.3, 14.4, 14.5_

- [x] 25.1 Write visual regression tests for dark theme
  - Test color contrast meets WCAG standards
  - Test all components render correctly with dark theme
  - _Requirements: 14.1, 14.2, 14.3_

- [x] 26. Implement accessibility features with tests
...
- [x] 26.1 Write unit tests for accessibility
  - Test ARIA labels presence
  - Test keyboard navigation
  - Test focus order
  - _Requirements: 12.3, 14.3_

- [x] 27. Add security headers and CSP
  - Configure Content Security Policy
  - Ensure API key never logged
  - Add warning about shared devices
  - _Requirements: 15.1, 15.2, 15.3, 15.5_

- [x] 27.1 Write tests for security measures
  - Test CSP configuration
  - Test API key not in console logs
  - Test warning display
  - _Requirements: 15.1, 15.2, 15.5_

- [x] 28. Optimize bundle size and performance
